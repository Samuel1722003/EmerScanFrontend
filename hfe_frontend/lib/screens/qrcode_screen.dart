...
class _QRCodeScreenState extends State<QRCodeScreen> {
  ...
  Future<void> _fetchUserQR() async {
    ...
    try {
      ...
      setState(() {
        ...
        qrBase64Data = userData['codigo_qr'] ?? '';
      });
    } catch (e) {
  ...
  Future<void> _copyBase64ToClipboard() async {
    await Clipboard.setData(ClipboardData(text: qrBase64Data));
    if (mounted) {
      ScaffoldMessenger.of(context).showSnackBar(
                        ...
                        child: Column(
                          children: [
                            qrBase64Data.isEmpty
                                ...
                                : QrImageView(
                                  data:
                                      qrBase64Data, // Ahora contiene el JSON como texto plano
