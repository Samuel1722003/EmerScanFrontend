...
Future<void> main() async {
  ...
  await Supabase.initialize(
    ...
    anonKey:
        'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6ImRtdmd0b2NrdG56YW16YXF2eWJyIiwicm9sZSI6ImFub24iLCJpYXQiOjE3NDQwMzU5ODMsImV4cCI6MjA1OTYxMTk4M30.D2CRrHdpdtprSRBbrCsaP26wDt5z1NS5GsjRkt1UxqE',
  );

  final client = Supabase.instance.client;

  try {
    final data = await client.from('usuario_persona').select().limit(1);
